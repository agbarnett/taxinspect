# initialise.labs.random.R
# function to initialise the labs with some random scatter
# Jan 2017

# see Table 1 from paper (global model parameters)
initialise.labs.random = 
  function(n = 100, # number of labs
    ...
    frame = data.frame(i=1:n, age=0, W_i=W_0, cum.papers=0, cum.FP=0, audit=0)
    frame$e_i = rnorm(n=n, mean=e_0, sd=1) # random effort
